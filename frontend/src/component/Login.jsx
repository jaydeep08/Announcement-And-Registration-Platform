...
if(alignment==='user'){
  ...
  if(res.status === 400|| !resData){
    ...
    else if(alignment==='club_admin'){
      const res = await fetch('/club_admin/login',{
        method:"POST",
        headers :{
          "Content-Type" : "application/json"
        },
...
>
  ...
  <ToggleButton value="club_admin" style={{fontWeight:"900"}}>Club_Admin</ToggleButton>
  <ToggleButton value="admin" style={{fontWeight:"900"}}>Faculty</ToggleButton>
